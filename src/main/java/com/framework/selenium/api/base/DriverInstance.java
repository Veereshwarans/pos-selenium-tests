...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "chrome":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://20.244.36.194:4444/wd/hub"), options));
			break;
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://20.244.36.194:4444/wd/hub"), firefoxOptions));
			break;
		case "edge":
