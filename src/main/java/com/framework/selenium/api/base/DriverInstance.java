...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "chrome":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://20.244.98.176:32000/wd/hub"), options));
			break;
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://20.244.98.176:32000/wd/hub"), firefoxOptions));
			break;
		case "edge":
